...
This project was to get familiar with HTML, CSS, JavaScript and Git. The main goal was to create a simple site that helped guide you through the step by step process of creating a site.
...
This project can be used by beginners to create a simple site to help them start out on their coding jouney.
